...
API_ID = int(environ['7403548'])
API_HASH = environ['251a611d9c8bc2f5d3223bf0a55da487']
BOT_TOKEN = environ['5065015315:AAEe7vczltUfz2Hh-Ioq_Q6N_KPFgXW7Hds']
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://harshsoni:QOiuh213MSIK@cluster0.8bd5tkd.mongodb.net/")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001644577352')).split()]
...
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1001644577352")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN .... [ i have added this to keep an eye on the users message, to avoid misuse of bot ]
...
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','REQUEST_MOvizz') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','REQUEST_MOvizz')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "REQUEST_MOvizz") #[ without @ ]
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '1733484689').split()]
...
DOWNLOAD_TEXT_URL = "https://telegram.me/R_MvzZ"

# Custom Caption Under Button #
CAPTION_BUTTON = "JOIN OUR COMMUNITY"
CAPTION_BUTTON_URL = "https://telegram.me/REQUEST_MOvizZ"
