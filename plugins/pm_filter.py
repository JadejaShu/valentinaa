        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ 𝙷𝚎𝚢 𝚜𝚘𝚗𝚊 `{message.from_user.first_name}` 😎,\n\nʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ꜱᴇɴᴛ ᴛᴏ ᴏᴜʀ **ᴀᴅᴍɪɴ'ꜱ ᴅᴀꜱʜʙᴏᴀʀᴅ** !\nᴘʟᴇᴀꜱᴇ ᴋᴇᴇᴘ ꜱᴏᴍᴇ ᴘᴀᴛɪᴇɴᴄᴇ !\nᴛʜᴇʏ ᴡɪʟʟ ᴜᴘʟᴏᴀᴅ ɪᴛ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ ᴘᴏꜱꜱɪʙʟᴇ.\n\n➟ 📝𝘾𝙤𝙣𝙩𝙚𝙣𝙩 𝙣𝙖𝙢𝙚 : `{search}`\n➟ 👮𝙍𝙚𝙦𝙪𝙚𝙨𝙩𝙚𝙙 𝘽𝙮 : `{message.from_user.first_name}`\n\n༺ @{MAIN_CHANNEL_USRNM} ",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Add me to group", url=f'http://telegram.me/MissValentinaa_Bot?startgroup=true')],[InlineKeyboardButton("BACKUP CHANNEL", url=f"https://telegram.me/{DEV_CHANNEL_USRNM}"),  InlineKeyboardButton("UPDATES CHANNEL", url=f"https://telegram.me/{MAIN_CHANNEL_USRNM}")],[InlineKeyboardButton("CLOSE", callback_data="close_data")]]))
